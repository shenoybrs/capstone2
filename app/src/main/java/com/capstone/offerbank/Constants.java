...
class Constants {
    ...
    public static final String TAG = ConstantsCls.TAG;

    /** The column that used to be used for the HTTP method of the request */
    public static final String RETRY_AFTER_X_REDIRECT_COUNT = ConstantsCls.RETRY_AFTER_X_REDIRECT_COUNT;

    /** The column that used to be used for the magic OTA update filename */
    public static final String OTA_UPDATE = ConstantsCls.OTA_UPDATE;

    /** The column that used to be used to reject system filetypes */
    public static final String NO_SYSTEM_FILES = ConstantsCls.NO_SYSTEM_FILES;

    /** The column that is used for the downloads's ETag */
    public static final String ETAG = ConstantsCls.ETAG;

    /** The column that is used for the initiating app's UID */
    public static final String UID = ConstantsCls.UID;

    /** The column that is used to remember whether the media scanner was invoked */
    public static final String MEDIA_SCANNED = ConstantsCls.MEDIA_SCANNED;

    /** The intent that gets sent when the service must wake up for a retry */
    public static final String ACTION_RETRY = ConstantsCls.ACTION_RETRY;

    /** the intent that gets sent when clicking a successful download */
    public static final String ACTION_OPEN = ConstantsCls.ACTION_OPEN;

    /** the intent that gets sent when clicking an incomplete/failed download  */
    public static final String ACTION_LIST = ConstantsCls.ACTION_LIST;

    /** the intent that gets sent when deleting the notification of a completed download */
    public static final String ACTION_HIDE = ConstantsCls.ACTION_HIDE;

    /** The default base name for downloaded files if we can't get one at the HTTP level */
    public static final String DEFAULT_DL_FILENAME = ConstantsCls.DEFAULT_DL_FILENAME;

    /** The default extension for html files if we can't get one at the HTTP level */
    public static final String DEFAULT_DL_HTML_EXTENSION = ConstantsCls.DEFAULT_DL_HTML_EXTENSION;

    /** The default extension for text files if we can't get one at the HTTP level */
    public static final String DEFAULT_DL_TEXT_EXTENSION = ConstantsCls.DEFAULT_DL_TEXT_EXTENSION;

    /** The default extension for binary files if we can't get one at the HTTP level */
    public static final String DEFAULT_DL_BINARY_EXTENSION = ConstantsCls.DEFAULT_DL_BINARY_EXTENSION;

    public static final String PROVIDER_PACKAGE_NAME = ConstantsCls.PROVIDER_PACKAGE_NAME;

    /** Holds the action name for download resume on reboot. */
    public static final String ACTION_RESUME_DOWNLOAD = ConstantsCls.ACTION_RESUME_DOWNLOAD;

    /**
     * When a number has to be appended to the filename, this string is used to separate the
     * base filename from the sequence number
     */
    public static final String FILENAME_SEQUENCE_SEPARATOR = ConstantsCls.FILENAME_SEQUENCE_SEPARATOR;

    /** Where we store downloaded files on the external storage */
    public static final String DEFAULT_DL_SUBDIR = ConstantsCls.DEFAULT_DL_SUBDIR;

    /** A magic filename that is allowed to exist within the system cache */
    public static final String RECOVERY_DIRECTORY = ConstantsCls.RECOVERY_DIRECTORY;
