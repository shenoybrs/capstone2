...
public class NetworkImageView extends ImageView {
     ...
     * immediately either set the cached image (if available) or the default image specified
     * by {@link com.android.volley.toolbox.NetworkImageView#setDefaultImageResId(int)} on the view.
     *
...
//                                            new BitmapDrawable(response.getBitmap()),
//                                            getResources().getDrawable(
//                                                    R.drawable.item_background_holo_dark) });

//                            setImageDrawable(d);
                            setImageBitmap(response.getBitmap());
                        } else if (mDefaultImageId != 0) {
                            Bitmap defaultRoundBitmap = AppUtils.getRoundedShape( BitmapFactory.decodeResource(getResources(), mDefaultImageId) );
                            setImageBitmap(defaultRoundBitmap);
                        }
